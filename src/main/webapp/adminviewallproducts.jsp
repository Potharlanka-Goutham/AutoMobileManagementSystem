...
<div class="demo">
    <h2 class="penName">View All Products</h2>
        ...
        <div class="mainCardContent">
            <c:forEach items="${productlist}" var="p">
                <div class="miniCard">
                    ...
                    <a href="<c:url value="adminviewproductbyid?id=${p.id}"></c:url>">View Product</a>
                </div>
            </c:forEach>
        </div>
    </div>
...
<script>
    function searchProducts() {
        var input, filter, cards, card, product, i, txtValue;
        ...
        for (i = 0; i < cards.length; i++) {
            card = cards[i];
            product = card.getElementsByClassName("description")[0];

...
<br>
  <div class="container">
    ...
    <div class="content">
      ...
      <form method="post" action="updateproductaction"  enctype="multipart/form-data">
        <div class="user-details">
        
        <div class="input-box">
    <span class="details">ID</span>
    <input type="text" name="id" placeholder="Enter name" value="${product.id}" readonly>
         </div>
          ...
          <div class="input-box">
            ...
            <input type="text" name="category" placeholder="category"  value="${product.category}" required>
          </div>
          <div class="input-box">
            <span class="details">description</span>
            <input type="text" name="description"  placeholder="Enter your email" value="${product.description}" required>
          </div>
          <div class="input-box">
            <span class="details">cost</span>
            <input type="text"  name="cost" placeholder="Enter cost"  value="${product.cost}" required>
          </div>
          <div class="input-box">
            <span class="details">stock</span>
            <input type="text"  name="stock" placeholder="Enter stock"  value="${product.stock}" required>
          </div>

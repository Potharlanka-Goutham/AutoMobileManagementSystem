        ...
        <div class="content">
            <form method="post" action="bookService">
                <div class="user-details">
                    <div class="input-box">
                        <span class="details">Pickup Location</span>
                        <input type="text" name="pickupLocation" placeholder="Enter pickup location" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Drop-Off Location</span>
                        <input type="text" name="dropOffLocation" placeholder="Enter drop-off location" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        <span class="details">Dropoff Date</span>

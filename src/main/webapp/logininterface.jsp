...
<body>
  ...
  <div class="background-two link-container">
    <a class="link-two" href="technicianlogin"  style="text-decoration: none;">Technician</a>
  </div>
  <div class="background-three link-container">
    <a class="link-three" href="adminlogin" style="text-decoration: none;">Administrators</a>
  </div>
